...
public class NaturalistEntityTypes {
    ...
    public static final RegistryObject<EntityType<Firefly>> FIREFLY = ENTITY_TYPES.register("firefly", () -> EntityType.Builder.of(Firefly::new, NaturalistMobCategories.FIREFLIES).sized(0.7F, 0.6F).clientTrackingRange(8).build(new ResourceLocation(Naturalist.MOD_ID, "firefly").toString()));
    ...
    public static final RegistryObject<EntityType<Snake>> CORAL_SNAKE = ENTITY_TYPES.register("coral_snake", () -> EntityType.Builder.of(Snake::new, MobCategory.CREATURE).sized(0.6F, 0.7F).clientTrackingRange(8).build(new ResourceLocation(Naturalist.MOD_ID, "coral_snake").toString()));
    public static final RegistryObject<EntityType<Snake>> RATTLESNAKE = ENTITY_TYPES.register("rattlesnake", () -> EntityType.Builder.of(Snake::new, MobCategory.CREATURE).sized(0.6F, 0.7F).clientTrackingRange(8).build(new ResourceLocation(Naturalist.MOD_ID, "rattlesnake").toString()));
