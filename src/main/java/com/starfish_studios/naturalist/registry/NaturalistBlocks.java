...
public class NaturalistBlocks {
    ...
    public static final RegistryObject<Block> CHRYSALIS = BLOCKS.register("chrysalis", () -> new ChrysalisBlock(BlockBehaviour.Properties.of(Material.PLANT).randomTicks().strength(0.2F, 3.0F).sound(SoundType.GRASS).noOcclusion().noCollission()));
