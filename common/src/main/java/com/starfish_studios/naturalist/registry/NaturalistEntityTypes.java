...
public class NaturalistEntityTypes {
    ...
    public static final Supplier<EntityType<Tortoise>> TORTOISE = CommonPlatformHelper.registerEntityType("tortoise", Tortoise::new, MobCategory.CREATURE, 1.0F, 0.875F, 10);
