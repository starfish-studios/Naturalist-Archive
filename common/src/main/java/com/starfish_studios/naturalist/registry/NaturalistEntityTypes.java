...
public class NaturalistEntityTypes {
    ...
    public static final Supplier<EntityType<Alligator>> ALLIGATOR = CommonPlatformHelper.registerEntityType("alligator", Alligator::new, MobCategory.CREATURE, 2.0F, 0.8F, 10);
