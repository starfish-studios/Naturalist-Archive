...
public class OstrichRenderer extends GeoEntityRenderer<Ostrich> {
    ...
    @Override
    public void renderEarly(Ostrich animatable, PoseStack stackIn, float ticks, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float partialTicks) {
