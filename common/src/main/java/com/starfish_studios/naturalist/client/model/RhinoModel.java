...
public class RhinoModel extends AnimatedGeoModel<Rhino> {
    @Override
    public Identifier getModelLocation(Rhino rhino) {
        return new Identifier(Naturalist.MOD_ID, "geo/rhino.geo.json");
    }

    @Override
    public Identifier getTextureLocation(Rhino rhino) {
        return new Identifier(Naturalist.MOD_ID, "textures/entity/rhino.png");
    }

    @Override
    public Identifier getAnimationFileLocation(Rhino rhino) {
        return new Identifier(Naturalist.MOD_ID, "animations/rhino.animation.json");
    }
