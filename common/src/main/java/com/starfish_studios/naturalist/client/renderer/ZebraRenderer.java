...
public class ZebraRenderer extends AbstractHorseRenderer<Zebra, ChestedHorseModel<Zebra>> {
    ...
    public ZebraRenderer(EntityRendererProvider.Context context) {
        super(context, new ChestedHorseModel<>(context.bakeLayer(LAYER_LOCATION)), 1.1F);
    }
