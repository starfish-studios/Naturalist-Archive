...
public class Lion extends AnimalEntity implements IAnimatable, SleepingAnimal {
    ...
    public static DefaultAttributeContainer.Builder createAttributes() {
        return MobEntity.createMobAttributes().add(EntityAttributes.GENERIC_MAX_HEALTH, 24.0D).add(EntityAttributes.GENERIC_MOVEMENT_SPEED, 0.3F).add(EntityAttributes.GENERIC_ATTACK_DAMAGE, 6.0D).add(EntityAttributes.GENERIC_FOLLOW_RANGE, 32.0D);
    }
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(4, new LionFollowParentGoal(this, 1.1));
    ...
    static class LionFollowParentGoal extends FollowParentGoal {
        ...
        @Override
        public boolean canStart() {
            return !this.lion.isSleeping() && super.canStart();
        }

        @Override
        public boolean shouldContinue() {
            return !this.lion.isSleeping() && super.shouldContinue();
        }
    }
}
